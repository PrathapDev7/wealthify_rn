...
const glyphs: Record<WealthifyIconName, any> = {
    auth_lock: remoteImage('assets/wealthify/glyph_256/auth_lock.png'),
    balance_top_up: remoteImage('assets/wealthify/glyph_256/balance_top_up.png'),
    wealthify_mark: remoteImage('assets/wealthify/glyph_256/wealthify_mark.png'),
    category_add: remoteImage('assets/wealthify/glyph_256/category_add.png'),
    category_bills: remoteImage('assets/wealthify/glyph_256/category_bills.png'),
    category_car: remoteImage('assets/wealthify/glyph_256/category_car.png'),
    category_education: remoteImage('assets/wealthify/glyph_256/category_education.png'),
    category_electricity: remoteImage('assets/wealthify/glyph_256/category_electricity.png'),
    category_entertainment: remoteImage('assets/wealthify/glyph_256/category_entertainment.png'),
    category_food: remoteImage('assets/wealthify/glyph_256/category_food.png'),
    category_fuel: remoteImage('assets/wealthify/glyph_256/category_fuel.png'),
    category_gas: remoteImage('assets/wealthify/glyph_256/category_gas.png'),
    category_gifts: remoteImage('assets/wealthify/glyph_256/category_gifts.png'),
    category_groceries: remoteImage('assets/wealthify/glyph_256/category_groceries.png'),
    category_gym: remoteImage('assets/wealthify/glyph_256/category_gym.png'),
    category_healthcare: remoteImage('assets/wealthify/glyph_256/category_healthcare.png'),
    category_home: remoteImage('assets/wealthify/glyph_256/category_home.png'),
    category_insurance: remoteImage('assets/wealthify/glyph_256/category_insurance.png'),
    category_internet: remoteImage('assets/wealthify/glyph_256/category_internet.png'),
    category_marketing: remoteImage('assets/wealthify/glyph_256/category_marketing.png'),
    category_mobile: remoteImage('assets/wealthify/glyph_256/category_mobile.png'),
    category_other: remoteImage('assets/wealthify/glyph_256/category_other.png'),
    category_rent: remoteImage('assets/wealthify/glyph_256/category_rent.png'),
    category_shopping: remoteImage('assets/wealthify/glyph_256/category_shopping.png'),
    category_subscription: remoteImage('assets/wealthify/glyph_256/category_subscription.png'),
    category_transport: remoteImage('assets/wealthify/glyph_256/category_transport.png'),
    category_travel: remoteImage('assets/wealthify/glyph_256/category_travel.png'),
    category_vacation: remoteImage('assets/wealthify/glyph_256/category_vacation.png'),
    category_water: remoteImage('assets/wealthify/glyph_256/category_water.png'),
    earn_rewards: remoteImage('assets/wealthify/glyph_256/earn_rewards.png'),
    earn_sharing: remoteImage('assets/wealthify/glyph_256/earn_sharing.png'),
    nav_account: remoteImage('assets/wealthify/glyph_256/nav_account.png'),
    nav_add: remoteImage('assets/wealthify/glyph_256/nav_add.png'),
    nav_analytics: remoteImage('assets/wealthify/glyph_256/nav_analytics.png'),
    nav_home: remoteImage('assets/wealthify/glyph_256/nav_home.png'),
    nav_transaction: remoteImage('assets/wealthify/glyph_256/nav_transaction.png'),
    premium_account: remoteImage('assets/wealthify/glyph_256/premium_account.png'),
    spending_wallet: remoteImage('assets/wealthify/glyph_256/spending_wallet.png'),
    subscriptions: remoteImage('assets/wealthify/glyph_256/subscriptions.png'),
    total_balance: remoteImage('assets/wealthify/glyph_256/total_balance.png'),
    track_referrals: remoteImage('assets/wealthify/glyph_256/track_referrals.png'),
    income_bonus: remoteImage('assets/wealthify/glyph_256/income_bonus.png'),
    income_business: remoteImage('assets/wealthify/glyph_256/income_business.png'),
    income_commission: remoteImage('assets/wealthify/glyph_256/income_commission.png'),
    income_freelance: remoteImage('assets/wealthify/glyph_256/income_freelance.png'),
    income_gift: remoteImage('assets/wealthify/glyph_256/income_gift.png'),
    income_interest: remoteImage('assets/wealthify/glyph_256/income_interest.png'),
    income_investment: remoteImage('assets/wealthify/glyph_256/income_investment.png'),
    income_other: remoteImage('assets/wealthify/glyph_256/income_other.png'),
    income_refund: remoteImage('assets/wealthify/glyph_256/income_refund.png'),
    income_rental: remoteImage('assets/wealthify/glyph_256/income_rental.png'),
    type_expense: remoteImage('assets/wealthify/glyph_256/type_expense.png'),
    type_income: remoteImage('assets/wealthify/glyph_256/type_income.png'),
    ui_bell: remoteImage('assets/wealthify/glyph_256/ui_bell.png'),
    ui_calendar: remoteImage('assets/wealthify/glyph_256/ui_calendar.png'),
    ui_settings: remoteImage('assets/wealthify/glyph_256/ui_settings.png'),
};

const aliases: Record<string, WealthifyIconName> = {
    add: 'category_add',
...
export const resolveWealthifyIconName = (name?: string): WealthifyIconName | undefined => {
    if (!name) return undefined;
    if (name in glyphs) return name as WealthifyIconName;
    return aliases[name];
};
...
const WealthifyIcon: React.FC<Props> = ({ name, size = 24, style }) => {
    const resolved = resolveWealthifyIconName(name);

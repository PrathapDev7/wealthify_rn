...
class AppColors extends ThemeExtension<AppColors> {
  ...
  /// Healthify (calorie tracker) palette — teal/cyan/navy brand, distinct
  ...
  static const AppColors healthifyLight = AppColors(
    ...
    primaryDarker: Color(0xFF134E4A),
    primarySoft: Color(0xFFCCFBF1),
    primarySoftStrong: Color(0xFF99F6E4),
    primaryGradientStart: Color(0xFF14B8A6),
    primaryGradientEnd: Color(0xFF0D9488),
    deepPurple: Color(0xFF0B1120),
    accent: Color(0xFF06B6D4),
    accentDark: Color(0xFF0891B2),
    accentSoft: Color(0xFFCFFAFE),
    negative: Color(0xFFE11D48),
    negativeDark: Color(0xFFBE123C),
    negativeSoft: Color(0xFFFFE4E6),
    warning: Color(0xFFF59E0B),
    warningSoft: Color(0xFFFEF3C7),
    info: Color(0xFF06B6D4),
    infoSoft: Color(0xFFCFFAFE),
    ...
    surface: Color(0xFFFFFFFF),
    surfaceMuted: Color(0xFFE6FFFA),
    surfaceSoft: Color(0xFFF0FDFA),
    surfaceLifted: Color(0xDBFFFFFF),
    surfaceElevated: Color(0xFFFFFFFF),
    overlay: Color(0x73172554),
    ...
    borderStrong: Color(0xFFB2DFDB),
    divider: Color(0xB8E0F2F1),
    fab: Color(0xFF172554),
    fabRing: Color(0xF2FFFFFF),
    lavenderWashTop: Color(0xFFE6FFFA),
    lavenderWashTopSoft: Color(0xFFF0FDFA),
    lavenderWashMid: Color(0xFFFFFFFF),
    lavenderWashBottom: Color(0xFFFFFFFF),
    inputBackground: Color(0xFFFFFFFF),
    inputBorder: Color(0xFFE0F2F1),
    category: _category,
  );
  ...
  static const AppColors healthifyDark = AppColors(
    ...
    primaryDarker: Color(0xFF0D9488),
    primarySoft: Color(0xFF134E4A),
    primarySoftStrong: Color(0xFF115E59),
    primaryGradientStart: Color(0xFF5EEAD4),
    primaryGradientEnd: Color(0xFF2DD4BF),
    deepPurple: Color(0xFF040711),
    accent: Color(0xFF22D3EE),
    accentDark: Color(0xFF06B6D4),
    accentSoft: Color(0xFF164E63),
    negative: Color(0xFFFB7185),
    negativeDark: Color(0xFFE11D48),
    negativeSoft: Color(0xFF4C0519),
    warning: Color(0xFFFBBF24),
    warningSoft: Color(0xFF451A03),
    info: Color(0xFF22D3EE),
    infoSoft: Color(0xFF164E63),
    pink: Color(0xFFF472B6),
    pinkSoft: Color(0xFF4A0E2E),
    cyan: Color(0xFF22D3EE),
    blue: Color(0xFF60A5FA),
    background: Color(0xFF0A1220),
    surface: Color(0xFF13233D),
    surfaceMuted: Color(0xFF0F1B30),
    surfaceSoft: Color(0xFF0A1220),
    surfaceLifted: Color(0xDB13233D),
    surfaceElevated: Color(0xFF13233D),
    overlay: Color(0x99000000),
    text: Color(0xFFE7ECF7),
    textStrong: Color(0xFFFFFFFF),
    textSecondary: Color(0xFF93A3C4),
    textBody: Color(0xFF93A3C4),
    textMuted: Color(0xFF93A3C4),
    textSubtle: Color(0xFF6B7CA0),
    textPlaceholder: Color(0xFF4B5A7A),
    textInverse: Color(0xFFFFFFFF),
    textOnPrimary: Color(0xFFFFFFFF),
    border: Color(0xFF16233D),
    borderStrong: Color(0xFF223252),
    divider: Color(0x8016233D),
    fab: Color(0xFFFFFFFF),
    fabRing: Color(0xE60A1220),
    lavenderWashTop: Color(0xFF0C1A22),
    lavenderWashTopSoft: Color(0xFF0A1620),
    lavenderWashMid: Color(0xFF0A1220),
    lavenderWashBottom: Color(0xFF0A1220),
    inputBackground: Color(0xFF13233D),
    inputBorder: Color(0xFF223252),
    category: _category,
  );
